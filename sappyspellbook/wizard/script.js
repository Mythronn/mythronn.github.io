...
function warlockCheck(index){
  ...
  if(abilities[51].purchased > 0){
    if(abilities[a].type == "Verbal" && !(abilities[a].school == "Death" || abilities[a].flame == "Flame")){
  ...
  if(abilities[a].name == "Warlock"){
    for(let i = 0; i < abilityCount; i++){
      if((abilities[i].type == "Verbal" && !(abilities[i].School == "Death" || abilities[i].range == "Flame")) && abilities[i].purchased > 0){
