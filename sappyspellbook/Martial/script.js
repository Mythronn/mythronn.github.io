 ...
 if(archetype == "Antipaladin"){
  ...
  archetypeText = `<div class="card">
      <div class="title"><u>Assassin</u></div>       
        ...
        <div class="entry"><b>Poison: 0-2/Life Charge x3 (ex)(LTP)</b><i> - I coat these weapons with a deadly poison x2</i></div>      
        <div class="entry"><b>Poison Arrow: 0-3 Arrows / Unlimited (ex)(LTP)</b><i> - Poison Arrow</i></div>      
  ...
  archetypeText = `<div class="card">
      <div class="title"><u>Hunter</u></div>       
        ...
        <div class="entry"><b>Pinning Arrow: 0-3 Arrow / Unlimited (ex)</b><i> - Pinning Arrow</i></div>
        <div class="entry"><b>Adaptive Protection: 1/Life (ex)</b><i> - I enchant thee with this protection x3</i></div>              
    </div>`;
 } 
  if(archetype == "Apex"){
